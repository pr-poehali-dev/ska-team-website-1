...
const Index = () => {
  ...
  const news = [
    {
      title: 'F — лучший игрок матча с Динамо-Шинник!',
      date: '2025-10-19',
      content: 'Нападающий F под номером 7 признан лучшим игроком матча против Динамо-Шинник! Его уверенная игра, голевые передачи и мастерство на льду стали ключевыми факторами победы нашей команды. Поздравляем F с заслуженной наградой!'
    },
    {
      title: 'Победа над Динамо-Шинник!',
      date: '2025-10-19',
      content: 'Команда СКА 1946 одержала уверенную победу над Динамо-Шинник со счетом 2:0! Поздравляем наших игроков с отличной игрой и важными очками в турнирной таблице!'
    },
    {
    ...
    {
      title: 'Новое пополнение в составе СКА 1946',
      date: '2025-10-11',
      content: 'Команда СКА 1946 объявляет о подписании нового игрока! Под номером 97 в наш состав присоединился vasilev. Добро пожаловать в команду!'
    }
  ];
