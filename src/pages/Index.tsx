...
const Index = () => {
  ...
  const news = [
    {
      title: 'Матч против Динамо-Шинник сегодня',
      date: '2025-10-19',
      content: 'Сегодня в 17:00 по московскому времени команда СКА 1946 сыграет против Динамо-Шинник. Приглашаем всех болельщиков поддержать нашу команду!'
    },
    {
