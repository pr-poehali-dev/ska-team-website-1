...
const Index = () => {
  ...
  const news = [
    ...
    {
      title: 'Тяжёлое поражение от Динамо-Шинник',
      date: '2025-10-12',
      content: 'Команда СКА 1946 потерпела крупное поражение от Динамо-Шинник со счетом 1:4. Команде предстоит работа над ошибками'
    },
    {
